...
REPO_URL="https://raw.githubusercontent.com/TheWebDexterTech/TWDxOSOptimisation/main/platforms/linux-debian"

# ── SHA256 digests of every remote file this installer fetches ────────────────
# Update these whenever the corresponding file changes.
declare -A FILE_CHECKSUMS=(
    ["configs/50unattended-upgrades"]="66da4354ac772a3f57bfb9231ca0f1b1331658f88e4c474a04bcdfa13aa9f66b"
    ...
    ["configs/auto-reboot.service"]="b0e03d93d6786d97b9b10e805f34370198c3d29cd9ab3000fa302582c28f9b65"
    ["configs/auto-reboot.timer.tpl"]="e3e8e67961657bc970a9c384c53c586c73974389c374c229a5f0e33f8385625a"
    ["configs/fail2ban-jail.local"]="7c106b9353af8df73f4353540d5fdc926d60b8daf43689cac61eb5aea5cbd81a"
...
if [[ "$DRY_RUN" == "true" ]]; then
    ...
    {
        echo "# TWDxOSOptimisation (Linux Debian/Ubuntu) — managed by installer"
...
if [[ "$DRY_RUN" == "true" ]]; then
    ...
    echo -e "${GREEN}  TWDxOSOptimisation (Linux Debian/Ubuntu) installed on $(hostname)${NC}"
fi
echo -e "${BOLD}────────────────────────────────────────────────────${NC}"
echo
printf "  %-28s %-14s\n" "Component" "Status"
